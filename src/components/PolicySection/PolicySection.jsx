...
export default function PolicySection() {
  return (
    <div className={classes.policyContainer}>
      <SectionTemplate topHeader="Privacy Policy and" buttomHeader="Terms" sectionImage='./privacyImage.png' sectionContent={<PolicyContent />} reversed={true} policySection={classes.policySection} />
      <div className={classes.privacyBackdrop}>
